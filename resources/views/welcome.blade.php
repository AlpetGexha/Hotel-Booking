<x-layout>
    ...
    <x-slot:metaDescription> {{ config('app.name') }} Booking - Find your perfect stay</x-slot:metaDescription>

    <!-- Hero Section with Background Image -->
    <div class="relative bg-cover bg-center h-[70vh] -mt-24 mb-24"
        style="background-image: url('{{ asset('images/hotel-bg.jpg') }}');">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
            <div class="text-center max-w-3xl mx-auto">
                <h1 class="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
                    <span class="block">Experience {{ config('app.name') }}</span>
                    ...
                    <div>
                        ...
                        <select id="guests" name="guests"
                            ...
                            @foreach (range(1, 6) as $i)
                                <option value="{{ $i }}">{{ $i }} {{ Str::plural('Person', $i) }}
                                </option>
                            @endforeach
                        </select>
                    </div>
    ...
    <div class="py-12 bg-white dark:bg-slate-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                <!-- Room Card 1 -->
                <div
                    class="overflow-hidden rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl bg-white dark:bg-slate-800">
                    <div class="relative pb-2/3">
                        <img src="https://images.unsplash.com/photo-1631049307264-da0ec9d70304?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                            alt="Deluxe Room" class="h-64 w-full object-cover">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-slate-900 dark:text-white">Deluxe Room</h3>
                        <p class="mt-2 text-slate-500 dark:text-slate-400">Perfect for solo travelers or couples looking
                            for comfort and style.</p>
                        <div class="mt-4 flex items-center justify-between">
                            <span class="text-indigo-600 dark:text-indigo-500 font-bold">$199 / night</span>
                            <a href="#"
                                class="text-sm font-medium text-indigo-600 dark:text-indigo-500 hover:text-indigo-500 dark:hover:text-indigo-400">
                                View Details →
                            </a>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="relative pb-2/3">
                        <img src="https://images.unsplash.com/photo-1590490360182-c33d57733427?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                            alt="Premium Suite" class="h-64 w-full object-cover">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-slate-900 dark:text-white">Premium Suite</h3>
                        <p class="mt-2 text-slate-500 dark:text-slate-400">Spacious suite with separate living area and
                            premium amenities.</p>
                        <div class="mt-4 flex items-center justify-between">
                ...
                <div
                    ...
                    <div class="relative pb-2/3">
                        <img src="https://images.unsplash.com/photo-1611892440504-42a792e24d32?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                            alt="Family Room" class="h-64 w-full object-cover">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-slate-900 dark:text-white">Family Room</h3>
                        <p class="mt-2 text-slate-500 dark:text-slate-400">Comfortable accommodations for the whole
                            family with extra space.</p>
                        <div class="mt-4 flex items-center justify-between">
