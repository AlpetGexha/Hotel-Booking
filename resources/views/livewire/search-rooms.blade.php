...
>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md mb-6">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Find Your Perfect Room</h1>
        ...
        <div class="p-6">
            <form wire:submit.prevent="search" class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <!-- Check-in Date -->
                <div>
                    <label for="checkInDate" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Check-in Date
                    </label>
                    <input
                        type="date"
                ...
                <!-- Check-out Date -->
                <div>
                    <label for="checkOutDate" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Check-out Date
                    </label>
                    <input
                        type="date"
                ...
                <div class="flex items-end">
                    <button
                        type="submit"
                        class="w-full inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:ring-offset-gray-800"
                    >
                    ...
                    <div>
                        ...
                        <div class="relative mt-3">
                            ...
                            <input
                                ...
                                class="w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-lg appearance-none cursor-pointer mt-4"
                            >
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            @foreach($amenities as $amenity)
                                <div class="flex items-center">
                                    ...
                                    >
                                    <label for="amenity-{{ $amenity->id }}" class="ml-2 text-sm text-gray-600 dark:text-gray-400">
                                        {{ $amenity->name }}
                                    </label>
                                </div>
                            @endforeach
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($roomTypes as $roomType)
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                        ...
                        <!-- Room Content -->
                        <div class="p-6">
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">{{ $roomType->name }}</h3>
                            ...
                            @if($roomType->amenities->count() > 0)
                                <div class="mb-4">
                                    <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Amenities</h4>
                            ...
                            <div class="flex items-center justify-between mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                                <div>
                                    ...
                                    <span class="text-gray-600 dark:text-gray-400 text-sm">/night</span>
                                ...
                                <a
                                    ...
                                    class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:ring-offset-gray-800"
                                >
                                    View Details
                                </a>
                            </div>
