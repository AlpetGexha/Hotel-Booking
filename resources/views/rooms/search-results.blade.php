                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-8">
                            <a href="#" class="font-medium text-gray-600 hover:text-indigo-500 dark:text-gray-300 dark:hover:text-indigo-400 transition duration-150">Rooms</a>
                            <a href="#" class="font-medium text-gray-600 hover:text-indigo-500 dark:text-gray-300 dark:hover:text-indigo-400 transition duration-150">Amenities</a>
                            <a href="#" class="font-medium text-gray-600 hover:text-indigo-500 dark:text-gray-300 dark:hover:text-indigo-400 transition duration-150">Gallery</a>
                            <a href="#" class="font-medium text-gray-600 hover:text-indigo-500 dark:text-gray-300 dark:hover:text-indigo-400 transition duration-150">Contact</a>

                            @if (Route::has('login'))
                                @auth
                                    <a href="{{ url('/dashboard') }}" class="font-medium text-gray-600 hover:text-indigo-500 dark:text-gray-300 dark:hover:text-indigo-400 transition duration-150">Dashboard</a>
                                @else
                                    <a href="{{ route('login') }}" class="font-medium text-gray-600 hover:text-indigo-500 dark:text-gray-300 dark:hover:text-indigo-400 transition duration-150">Log in</a>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md mb-6">
                        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Available Room Types</h1>

                            <div class="mt-2 flex flex-wrap items-center gap-4 text-gray-600 dark:text-gray-400">
                                <div class="flex items-center">
                        ...
                        <!-- Search Form -->
                        <div x-data="{ showFilters: false }" class="p-6 bg-gray-50 dark:bg-gray-900/50">
                            <button
                                @click="showFilters = !showFilters"
                                class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
                            >
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        @empty
                            <div class="col-span-3 bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 text-center">
                                ...
                                <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">No rooms available</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <div class="flex space-x-4">
                                <a href="#" class="text-gray-300 hover:text-indigo-400 transition duration-150">
